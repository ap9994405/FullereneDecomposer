...
//    view->setViewport(new QGLWidget(QGLFormat(QGL::SampleBuffers)));
    ...
    QColor color3(198,224,180); //#C6E0B4
    QColor color4(226,239,218); //#E2EFDA
    int colorcount ;
    ...
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C20);
        QStringList namelist = subItemsText.split("_");
        QString symmetry = namelist.at(2);
        QString number = namelist.at(1);
        QString filename = "Isomer " + number + " (" + symmetry.at(0) + "<sub>" + symmetry.mid(1) + "</sub>)";
        subItem->getQLabel()->setText(filename);
        colorcount = colorcount + 1;
        if (colorcount%2 == 0)
        {
          subItem->getQLabel()->setStyleSheet("background-color: #C6E0B4;");
        }
        else
        {
          subItem->getQLabel()->setStyleSheet("background-color: #E2EFDA;");
        }
    }
    //===============================================================================================
    // mainTreeWidgetItem
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C24);
        QStringList namelist = subItemsText.split("_");
        QString symmetry = namelist.at(2);
        QString number = namelist.at(1);
        QString filename = "Isomer " + number + " (" + symmetry.at(0) + "<sub>" + symmetry.mid(1) + "</sub>)";
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C26);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C28);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C30);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C32);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C34);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C36);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C38);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C40);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C42);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C44);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C46);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C48);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C50);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C52);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C54);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C56);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C58);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C60);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C62);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C64);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C66);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C68);
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C70);
    ...
    text = "C72";
    C72->setText(0, ch2subscript(text));
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C72);
    ...
    text = "C80";
    C80->setText(0, ch2subscript(text));
    C80->setBackground(0, QBrush(color1));
    // sbuTreeWidgetItem
    ...
    for (const QString &subItemsText : subItems)
    {
        CustomTreeWidgetItem *subItem = new CustomTreeWidgetItem(C80);
...
void BuilderWidget::leftClicked3(const QString molecule, const QString text)
{
    QString m_molecule = molecule;
    QString m_Isomer = text;
    m_Isomer = m_Isomer.replace(" (", " ").left(m_Isomer.length() - 2);

    Loadgraph(m_molecule,m_Isomer,8.5);
}
...
void BuilderWidget::onTreeItemClicked(QTreeWidgetItem *item, int column)
{
    ...
    //qDebug() << "click";
    subText = subText.replace(" (", " ").left(subText.length() - 2);
    ...
    if (MainItem)
    {
        ...
        if (subText.length() > 3)
        {
            Loadgraph(MainText,subText,8.5);
        }
    }
