...
void ZZCalculatorJob::calcFinished()
{
    ...
    if (!m_calc->hasError())
    {
        ...
        //m_result->setData(99,"<font color='#e69707'>star polynomial</font> <br>" + m_calc->getPoly().toHTML()  + "<br>Total: " + m_calc->getTotal() + "<br><br><font color='#0e7fed'>ZZ polynomial</font><br>" + m_calc->getPoly2().toHTML() + "<br>Total: " + m_calc->getTotal2());
        //m_result->setData(99,"<span style='color: #FFA500; font-weight: bold;'>star polynomial</span> <br>" + m_calc->getPoly().toHTML()  + "<br>Total: " + m_calc->getTotal() + "<br><br><font color='#0e7fed'>ZZ polynomial</font><br>" + m_calc->getPoly2().toHTML() + "<br>Total: " + m_calc->getTotal2());
        m_result->setData(98,"star polynomial <br>" + m_calc->getPoly().toHTML2() + "<br>Total: " + m_calc->getTotal() + "<br><br>ZZ polynomial <br>" + m_calc->getPoly2().toHTML() + "<br>Total: " + m_calc->getTotal2());
