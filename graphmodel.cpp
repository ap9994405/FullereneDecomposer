...
QList<GraphModel *> GraphModel::getDaughters(EdgeModel edge)
{
    ...
    for (int i=0; i<m_edges.size();++i)
    {
        if (m_edges[i].startPoint() == edge.startPoint() && m_edges[i].endPoint() != edge.endPoint())
        {
            ...
            {
                if (j >= m_edges.size()){qDebug() << "Index j is out of bounds!";}
                if (j == i)
                {
                    continue;
                }
...
//         all_edges.insert(m_edges[i]);
//     }
//     bool findneighbor,findneighbor2,findneighbor3,findneighbor4,findneighbor5;
//     QList<EdgeModel> tmpPath;
//     QPoint atom1,atom2,atom3,atom4,atom5,atom6;
//     atom1 = edge.startPoint();
//     atom2 = edge.endPoint();
...
//         findneighbor5 = false;
//         tmpPath.clear();
//         tmpPath << edge<< edge<< edge<< edge<< edge<< edge;

//         // tmpPath.replace(1, edge);

//         if(atom1 == m_edges[i].startPoint())
//         {
//             if (!tmpPath.contains(m_edges[i]))
//             {
//                 atom3 = m_edges[i].endPoint();
//                 // tmpPath.append(m_edges[i]);
//                 tmpPath.replace(2, m_edges[i]);
//                 findneighbor = true;
//             }
//         }
//         else if (atom1 == m_edges[i].endPoint())
//         {
//             if (!tmpPath.contains(m_edges[i]))
//             {
//                 atom3 = m_edges[i].startPoint();
//                 // tmpPath.append(m_edges[i]);
//                 tmpPath.replace(2, m_edges[i]);
//                 findneighbor = true;
//             }
...
//             for(int j=0; j<m_edges.size();++j)
//             {
//                 if (atom3 == m_edges[j].startPoint() && !tmpPath.contains(m_edges[j]))
//                 {
//                     atom4 = m_edges[j].endPoint();
//                     // tmpPath.append(m_edges[j]);
//                     tmpPath.replace(3, m_edges[j]);
//                     findneighbor2 = true;
//                 }
//                 else if (atom3 == m_edges[j].endPoint() && !tmpPath.contains(m_edges[j]))
//                 {
//                     atom4 = m_edges[j].startPoint();
//                     // tmpPath.append(m_edges[j]);
//                     tmpPath.replace(3, m_edges[j]);
//                     findneighbor2 = true;
//                 }
...
//                     {
//                         if (atom2 == m_edges[k].startPoint() && !tmpPath.contains(m_edges[k]))
//                         {
//                             atom5 = m_edges[k].endPoint();
//                             // tmpPath.append(m_edges[k]);
//                             tmpPath.replace(4, m_edges[k]);
//                             findneighbor3 = true;
//                         }
//                         else if (atom2 == m_edges[k].endPoint() && !tmpPath.contains(m_edges[k]))
//                         {
//                             atom5 = m_edges[k].startPoint();
//                             // tmpPath.append(m_edges[k]);
//                             tmpPath.replace(4, m_edges[k]);
//                             findneighbor3 = true;
//                         }
...
//                             for(int l=0; l<m_edges.size();l++)
//                             {
//                                 if(atom5 == m_edges[l].startPoint() && !tmpPath.contains(m_edges[l]))
//                                 {
//                                     atom6 = m_edges[l].endPoint();
//                                     // tmpPath.append(m_edges[l]);
//                                     tmpPath.replace(5, m_edges[l]);
//                                     findneighbor4 = true;
//                                 }
//                                 else if(atom5 == m_edges[l].endPoint() && !tmpPath.contains(m_edges[l]))
//                                 {
//                                     atom6 = m_edges[l].startPoint();
//                                     // tmpPath.append(m_edges[l]);
//                                     tmpPath.replace(5, m_edges[l]);
//                                     findneighbor4 = true;
//                                 }
//                                 if (findneighbor4 && atom4 != atom6)
//                                 {
//                                     findneighbor4 = false;
//                                     for(int m=0; m<m_edges.size();m++)
//                                     {
//                                         if (atom4 == m_edges[m].startPoint() && atom6 == m_edges[m].endPoint()) 
//                                         {
//                                             findneighbor5 = true;
//                                             tmpPath.replace(6, m_edges[m]);
//                                             res.append(tmpPath);

//                                         }
//                                         else if (atom4 == m_edges[m].endPoint() && atom6 == m_edges[m].startPoint()) 
//                                         {
//                                             findneighbor5 = true;
//                                             tmpPath.replace(6, m_edges[m]);
//                                             // tmpPath.append(m_edges[m]);
//                                             res.append(tmpPath);
//                                         }
//                                         // qDebug() <<findneighbor5;
//                                         // if (findneighbor5)
//                                         // {
//                                         //     findneighbor5 = false;
//                                         //     tmpPath.clear();
...
//                                         //     {
//                                         //         if (atom1 == m_edges[m].startPoint() && atom3 == m_edges[m].endPoint())
//                                         //         {
//                                         //             tmpPath.append(m_edges[m]);
//                                         //         }
//                                         //         else if (atom3 == m_edges[m].startPoint() && atom1 == m_edges[m].endPoint())
//                                         //         {
//                                         //             tmpPath.append(m_edges[m]);
//                                         //         }
//                                         //         else if (atom3 == m_edges[m].startPoint() && atom4 == m_edges[m].endPoint())
//                                         //         {
//                                         //             tmpPath.append(m_edges[m]);
//                                         //         }
//                                         //         else if (atom4 == m_edges[m].startPoint() && atom3 == m_edges[m].endPoint())
//                                         //         {
//                                         //             tmpPath.append(m_edges[m]);
//                                         //         }
//                                         //         else if (atom2 == m_edges[m].startPoint() && atom5 == m_edges[m].endPoint())
//                                         //         {
//                                         //             tmpPath.append(m_edges[m]);
//                                         //         }
//                                         //         else if (atom5 == m_edges[m].startPoint() && atom2 == m_edges[m].endPoint())
//                                         //         {
//                                         //             tmpPath.append(m_edges[m]);
//                                         //         }
//                                         //         else if (atom5 == m_edges[m].startPoint() && atom6 == m_edges[m].endPoint())
//                                         //         {
//                                         //             tmpPath.append(m_edges[m]);
//                                         //         }
//                                         //         else if (atom6 == m_edges[m].startPoint() && atom5 == m_edges[m].endPoint())
//                                         //         {
//                                         //             tmpPath.append(m_edges[m]);
//                                         //         }
//                                         //         else if (atom4 == m_edges[m].startPoint() && atom5 == m_edges[m].endPoint())
//                                         //         {
//                                         //             tmpPath.append(m_edges[m]);
//                                         //         }
//                                         //         else if (atom5 == m_edges[m].startPoint() && atom4 == m_edges[m].endPoint())
//                                         //         {
//                                         //             tmpPath.append(m_edges[m]);
//                                         //         }
//                                         //         if (tmpPath.size() == 6)
...
//                                         // }
//                                     }
//                                 // do not use append above instead using atom1~6 find edge then append below
//                                 }
//                             }
//                         }
//                     }
