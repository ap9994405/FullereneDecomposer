#ifndef DECOMPOSER2_H
#define DECOMPOSER2_H
...
class Decomposer2 : public QWidget
{
    Q_OBJECT
    friend class GraphDecomposeCommand2;
public:
    explicit Decomposer2(UniqueTagGenerator *tagGen = 0, QWidget *parent = 0);
    ~Decomposer2();
